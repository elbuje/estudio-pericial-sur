...
<head>
  ...
  <script type="application/ld+json">
  {
    ...
    "image": "https://pericias.tecnobrain.ar/assets/img/fedenowback/evento_encende_tu_fuego.jpg",
  ...
  <section class="hero">
    ...
    <div class="container">
      <div class="hero-grid">
        ...
        <!-- Flyer Oficial -->
        <div>
          <img src="/assets/img/fedenowback/evento_encende_tu_fuego.jpg" alt="Flyer Oficial Encendé tu Fuego - Fede Nowback" class="flyer-hero-img">
        </div>
  ...
  <section class="section-wrap" style="background: rgba(255,255,255,0.015);">
    <div class="container">
      ...
      <div class="gallery-grid" style="margin-bottom: 36px;">
        ...
        <div class="gallery-item">
          <img src="/assets/img/fedenowback/evento_encende_tu_fuego.jpg" alt="Flyer Evento CABA">
          <div class="gallery-overlay">
